...
// 1. 선생님의 최신 API 키와 명확한 모델 경로 설정
const apiKey = "AIzaSyCsWUKo9enUQs4VUXVsS1I_JLd2X38s7gg"; 
// 모델명 앞에 'models/'를 붙이는 것이 가장 안전한 표준입니다.
    ...
    try {
      ...
      const res = await fetch(apiUrl, {
        ...
        body: JSON.stringify({
          contents: [{
            parts: [{
              text: `당신은 따뜻한 기독교 상담가입니다. 다음 고민에 대해 성경적인 위로와 짧은 기도문을 따뜻한 한국어로 작성해주세요: ${userInput}`
            }]
          }]
        })
      });
